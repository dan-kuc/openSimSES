...
[inputTech.agingMdl,        ...
    ...
    inputTech.callFctAgingMdl  ]       = createAgingModel('typeAgingMdl', inputTech.typeAgingMdl);
...
if(inputFcr.flagFcrSupply)
    % generate fcr frequency data
    [ inputFcrProfiles.fcrFrequency]       = createProfiles(                                    ...
        'profile',  frequencyProfile,                       ...
        'tSample',  inputSim.tSample,                       ...
        'tSim',     [inputSim.simStart, inputSim.simEnd],   ...
        'tProfile', length(frequencyProfile)                );
    
else
    inputFcrProfiles.fcrFrequency 	= [];
end
