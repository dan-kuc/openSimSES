...
% battery.
%
% Combination type: Maximum
% Description:      Takes stronger aging out of calendric and cyclic capacity and resistance change
% Input values:
...
function agingTotal = combAgingType_Maximum(agingCalendric, agingCyclic, agingStress, index, sampleTime)

% Calculate combination of aging
agingTotal.relCapacityChange    = min(agingCalendric.relCapacityChange, agingCyclic.relCapacityChange);
agingTotal.relResistanceChange  = max(agingCalendric.relResistanceChange, agingCyclic.relResistanceChange); 
